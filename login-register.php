	...
	<div class="my-account style-1 margin-top-5 margin-bottom-40">
		...
		<div class="tabs-container alt">
			...
			<div class="tab-content" id="tab1" style="display: none;">
				...
				<?php
					if (isset($_POST['login'])) {
						...
						$msg_confpasse=" mot de passe ou email incorrect";
						// debut de test !
						if ($_POST['email_connect']=='') {
							$msg_erreur= $msg_erreur."email, ";
							$cmp=$cmp+1;
						}
						if ($_POST['password']=='') {
							
							$msg_erreur= $msg_erreur."password, ";
							$cmp=$cmp+1;
						}
						...
						if ($cmp != 0) {
							...
							$rqt="select * from utilisateurs where email='$email_connect' and passe='$password'";
							$qry=mysqli_query($success, $rqt)or die('erreur de sql'.$sql.'<br>'.mysqli_error());
							$verify=0;
					...
					<p class="form-row form-row-wide">
						<label for="username">email :
							...
							<input type="text" class="input-text" name="email_connect" id="email_connect" value="" />
						</label>
					</p>
					...
					<p class="lost_password">
						<a href="mot_passe_oublier.php" >Mot de passe perdu?</a>
					</p>
			...
			<!--######### DEBUT CODE SUBMIT REGISTER #########-->
				...
				<form method="post" action="#tab2">
					...
					if (isset($_POST['register'])) {
						...
						if ($cmp != 0) {
							...
							// la requete !
							// f haad l insert ghaadii tzaad hadiik session dyalt user mansaaach nziido hta f requete
							$rqt="insert into utilisateurs(nom,prenom,tel,email,ville,passe) values('$nom','$prenom','$telephone','$email','$ville','$password1') ";
							$qry=mysqli_query($success,$rqt)or die('erreur de sql'.$sql.'<br>'.mysqli_error());
				...
				<p class="form-row form-row-wide">
					<label for="email2">ville:
						<i class="sl sl-icon-location"></i>
						<input type="text" class="input-text" name="ville" value="" />
					</label>
				</p>
