...
echo '<tbody>';
					...
					echo '<a href="nouveau-message-admin.php" class="button preview margin-top-5" id="nv-msg" onclick="document.forms["my-form"].submit();return false;">Nouveau message</a>';
					echo "<br><br>";
...
//supp.php?id='.$data['id_utilisateur'].'
				...
				echo '<tr >
						...
						<a href="affiche-message-admin.php?date='.$data['date_msg'].'&user='.$data['id_utilisateur'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Afficher</a>
						
						</td>

						<td align=center> 
						
						<a href="supp-msg-admin.php?id_cnt='.$data['id_contact'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Supprimer</a>
