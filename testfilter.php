		...
		<div class="col-md-12">
			...
			<div class="listings-container list-layout">
				...
				//select * from annonces where type_offre='.$type_offre.' and type_bien='.$type_bien.' and ville='.$ville.'
					...
					$query = mysqli_query($success,"SELECT * from annonces WHERE annonces.type_bien='$type_bien' or annonces.type_offre='$type_offre' or annonces.ville='$ville'and valider=1");
