			...
			<div class="sidebar left">
				...
				<div class="my-account-nav-container">
					...
					<ul class="my-account-nav">
						...
						<li><a href="mon_profile_admin.php" class="current"><i class="sl sl-icon-user"></i> Mon Profil </a></li>
					</ul>
					
					<ul class="my-account-nav">
						<li class="sub-nav-title">Manage Listings</li>
						<li><a href="my-properties.html"><i class="sl sl-icon-docs"></i> Mes annonces </a></li>
						...
						<li><a href="#"><i class="sl sl-icon-grid "></i> Annonces deposé </a></li>
						...
						<li><a href="#"><i class="sl sl-icon-note "></i> Reservation </a></li>
						<li><a href="message-admin.php"><i class="sl sl-icon-envelope-open "></i> Message </a></li>
						<li><a href="#"><i class="sl sl-icon-chart "></i> Statistique </a></li>
					</ul>

					<ul class="my-account-nav">
					<li><a href="change-password-admin.php"><i class="sl sl-icon-lock"></i> Change mot de passe</a></li>
			...
			<div class="row">
				...
				<div class="col-md-8 my-profile">
					...
					<?php
							...
							$msg_erreur = "Message, Sujet ou bien email non remplie !";
							$msg_envoyer = "Message envoyer !";

							if (isset($_POST['repond-msg'])) {
								if ($_POST['repond']=="" or $_POST['sujet']=="" or $_POST['email']=="") {
									...
									$cmp=0;
									$query=mysqli_query($success,"select * from Utilisateurs where email='$email'") or die('Erreur SQL !<br />'.$sql.'<br />'.mysqli_error());
									...
									if ($cmp == 0) {
										echo '<span style="color:red">Aucun utilisateur contient ce email !</span>';
									}else{
									// la requet SQL !
											// hnaya f blasset raaa9m 1 ghadii nbeedlooh b session !
										$qry=mysqli_query($success,"insert into contact(id_utilisateur,id_distinateur,sujet,message)values(1,$id_user,'$sujet','$message') ") or die('Erreur SQL !<br />'.$sql.'<br />'.mysqli_error());
						...
						echo '
								...
								<span style="color:blue"> Sujet : </span>
								<br>
