	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Annonces Deposer</h2>

				<!-- Breadcrumbs -->
				<nav id="breadcrumbs">
					<ul>
						<li>Accueil</li>
						<li>Annonces deposer</li>
				    </ul>
				</nav>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<h4 class="margin-top-0 margin-bottom-30"> Annonces déposer </h4>
...
echo '<thead>';
		...
		<th style="text-align:center" > <span style="color:blue"> Quartier </span></th>
		<th style="text-align:center" > <span style="color:blue"> Description </span></th>
		...
		<th style="text-align:center" > <span style="color:blue"> Valider </span></th>
	  </tr>';
echo '</thead>';
echo '<tbody>';
					...
					// la requet SQL !
						...
						$qry=mysqli_query($success,"select concat(utilisateurs.nom,' ',utilisateurs.prenom) as 'Nom complet',annonces.titre,annonces.quartier,annonces.discription,annonces.type_offre,annonces.type_bien,annonces.ville, annonces.date_annonce from annonces,utilisateurs where annonces.id_user=utilisateurs.id_utilisateur  and annonces.valider=0");
					...
					// le tableau avec les donnee !
						...
						$compteur_annonces = $compteur_annonces + 1 ;
				...
				echo '<tr >
						...
						<td align=center nowrap="nowrap" >'.$data['quartier'].'</td>
						...
						<a href="valider-annonces.php?date='.$data['date_annonce'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Valider</a>
...
echo '<br>le nombre d\'annonces est :'.$compteur_annonces;
