	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<h4 class="margin-top-0 margin-bottom-30"> Reservation </h4>
...
echo '<tbody>';
					...
					// variable pour a session id_user
					$id_user=$_SESSION['id_user'];
					

						$qry=mysqli_query($success,"select concat(utilisateurs.nom,' ',utilisateurs.prenom) as 'Nom complet',reservation.date_reservation,annonces.titre,annonces.type_bien,annonces.type_offre,annonces.ville,annonces.prix from reservation,utilisateurs,annonces WHERE utilisateurs.id_utilisateur=reservation.id_utilisateur and annonces.id_annonce=reservation.id_annonce");
...
// le tableau avec les donnee !
				...
				echo '<tr >
						...
						<a href="supp-reservation-admin.php?date='.$data['date_reservation'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Supp</a>
