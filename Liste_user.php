	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<h4 class="margin-top-0 margin-bottom-30"> Utilisateurs </h4>
...
echo '<form name="my-form" method="POST" action="Liste_user.php">';

echo '<table  class="table">';
echo '<thead>';

					echo '<tr>
		<th style="text-align:center" > <span style="color:blue"> Nom </span></th>
		<th style="text-align:center" > <span style="color:blue">Prenom </span></th>
		<th style="text-align:center" > <span style="color:blue">Tel </span></th>
		<th style="text-align:center" > <span style="color:blue">Email </span></th>
...
echo '<tbody>';
					...
					// la requet SQL !
						...
						$qry=mysqli_query($success,"select * from utilisateurs where type_user='Simple'");
				...
				echo '<tr >
						...
						<a href="supp.php?id='.$data['id_utilisateur'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Supp</a>
				...
				/*<td align=center>
						<input type="hidden" name="supp_user" value="ok" >
						<a href="Liste_user.php?id='.$data['id_utilisateur'].'" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Supp</a>*/
...
echo '<br>le nombre d\'utilisateur est :'.$compteur_user;
