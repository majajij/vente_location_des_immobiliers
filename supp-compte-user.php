		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-6  my-profile">
					<h4 class="margin-top-0 margin-bottom-30">Supprimer mon compte</h4>

					<form method="POST">
					<label>Vouler-vous vraiment supprimer ?!</label>
				...
				{
					//blaseet diik 1 ghadi nbeedlooha b session dyal user !
						$qry=mysqli_query($success,"delete from utilisateurs where id_utilisateur=10") or die('Erreur SQL !<br />'.$sql.'<br />'.mysqli_error());
				...
				{
						echo '<script>alert("suppression annuler !")</script>';
				}
						?>
