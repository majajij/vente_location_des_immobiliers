	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<h4 class="margin-top-0 margin-bottom-30"> Annonces </h4>
...
echo '<tbody>';
					...
					// la requet SQL !
						...
						$qry=mysqli_query($success,"select concat(utilisateurs.nom,' ',utilisateurs.prenom) as 'Nom complet',annonces.titre,annonces.quartier,annonces.discription,annonces.type_offre,annonces.type_bien,annonces.ville, annonces.date_annonce from annonces,utilisateurs where annonces.id_user=utilisateurs.id_utilisateur  and annonces.valider=1");
				...
				echo '<tr >
						...
						<a href="supp-annonces-admin.php?date='.$data['date_annonce'].'&menu=Liste_annonces" class="button preview margin-top-5" onclick="document.forms["my-form"].submit();return false;">Supp</a>
